...
-- 2. Operators table: Licensed gaming companies per state
...
-- 3. Users table: Deterministic access based on state_id
CREATE TABLE IF NOT EXISTS users (
    id INT AUTO_INCREMENT PRIMARY KEY,
    state_id INT NULL, -- NULL for 'global_admin' or 'consultant' who can see all states
    operator_id INT NULL, -- Link for operator_admin users
