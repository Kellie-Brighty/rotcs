...
const varianceData = [
  {
    ...
    operator: 'Bet9ja',
    period: 'Dec 2025',
    reportedGGR: 320000000,
    calculatedGGR: 320500000,
    variance: 0.15,
    status: 'green',
  },
  {
    ...
    operator: 'SportyBet',
    period: 'Dec 2025',
    reportedGGR: 280000000,
    calculatedGGR: 281200000,
    variance: 0.42,
    status: 'amber',
  },
  {
    ...
    operator: '1xBet',
    period: 'Dec 2025',
    reportedGGR: 250000000,
    calculatedGGR: 252800000,
    variance: 1.12,
    status: 'red',
  },
  {
    ...
    operator: 'BetKing',
    period: 'Dec 2025',
    reportedGGR: 220000000,
    calculatedGGR: 220100000,
    variance: 0.04,
    status: 'green',
  },
]
...
const DataReconciliationViewer = () => {
  const columns = [
    ...
    {
      title: 'Reported GGR',
      dataIndex: 'reportedGGR',
      key: 'reportedGGR',
      render: (value: number) => `₦${(value / 1000000).toFixed(1)}M`,
    },
    {
      title: 'Calculated GGR',
      dataIndex: 'calculatedGGR',
      key: 'calculatedGGR',
      render: (value: number) => `₦${(value / 1000000).toFixed(1)}M`,
    },
    {
